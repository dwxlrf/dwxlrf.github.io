...
![img](assets/1599816961031-50214498-7822-4a9f-b060-4d9fd1b27973.png)
...
![img](assets/1599817000666-386578e7-6152-40dd-a28b-795ab3d574cb.png)
...
![img](assets/1599817019773-473ce40a-c573-4fbf-8a2e-0a395964cca9.png)
...
#### 3.1 判断一文件是不是字符设备文件，如果是将其拷贝到 `/dev` 目录下？
...
#### 3.2 添加一个新组为 class1 ，然后添加属于这个组的 30 个用户，用户名的形式为 stdxx ，其中 xx 从 01 到 30 ？
...
#### 3.3 写一个 sed 命令，修改 `/tmp/input.txt` 文件的内容？
...
![img](assets/1599819825808-915f17cf-c615-479b-98e0-250b9a50f046.png)
