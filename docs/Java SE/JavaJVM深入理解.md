...
![img](assets/1600160738931-5c7ff422-69a2-4ae2-9961-405b7b1fcd0c.png)
...
![img](assets/1600160765721-85b72e4c-4805-49b8-b578-c9b761dd475d.png)
...
![img](assets/1600160794411-a14e82d6-6186-4898-ba7b-772e008d2a58.png)
...
![img](assets/1600160821570-246a88a6-32e7-4a94-91b2-67eabff517a7.png)

下面是对象创建的主要流程:

![img](assets/1600160851756-3163c38a-ba9e-4d75-9231-b678dc0929bc.png)
...
![img](assets/1600160910427-3c907cbf-83a2-4135-a237-21209701da21.png)
...
![img](assets/1600160933143-9a331fc1-4e6a-4ec6-b0aa-c6526aaed9ba.png)
...
![img](assets/1600160969736-0a56e7b3-4856-4e8c-8676-5adb57af0a20.png)
...
![img](assets/1600160994574-ef6f24d1-4d93-4b96-9164-5aec15f33fc6.png)
...
![img](assets/1600161103822-ec3d9e15-256a-4281-bcf0-149e221ed688.png)
...
![img](assets/1600161131593-8dcc85e2-d68a-438e-913a-9a6e444fdd2e.png)
...
![img](assets/1600161166700-69fdf59c-ef57-446d-974b-a8bbee1ff722.png)

#### 9.4 分代收集算法

当前商业虚拟机都采用**分代收集**的垃圾收集算法。分代收集算法，顾名思义是根据对象的**存活周期**将内存划分为几块。一般包括**年轻代**、**老年代** 和 **永久代**，如图所示：

![img](assets/1600161244282-6dc0443e-6ab6-4cb7-800b-52697918985b.png)

### 10 JVM 有哪些垃圾回收器？

如果说垃圾收集算法是内存回收的方法论，那么垃圾收集器就是内存回收的具体实现。下图展示了7种作用于不同分代的收集器，其中用于回收新生代的收集器包括Serial、PraNew、Parallel Scavenge，回收老年代的收集器包括Serial Old、Parallel Old、CMS，还有用于回收整个Java堆的G1收集器。不同收集器之间的连线表示它们可以搭配使用。

![img](assets/1600161319557-e587720f-453c-44be-a9fd-9980491db6b6.png)
...
![img](assets/1600161354457-16d15207-6410-43fe-a7ea-6f0375d0fe0e.png)
